...
{
    public partial class HomeNearHotelCell : UICollectionViewCell
    {
        public static readonly NSString Key = new NSString("HomeNearHotelCell");
        public static readonly UINib Nib;

        static HomeNearHotelCell()
        {
            Nib = UINib.FromName("HomeNearHotelCell", NSBundle.MainBundle);
        }

        protected HomeNearHotelCell(IntPtr handle) : base(handle)
        {
